function Users(props) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm hover:shadow-xl hover:-translate-y-1 transition duration-300 p-5 text-center border border-gray-100 hover:border-blue-200">
