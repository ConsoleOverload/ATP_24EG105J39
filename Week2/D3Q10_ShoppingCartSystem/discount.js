...
// Available coupons
                          ...
                          export function validateCoupon(couponCode, cartTotal, cartItems) {
                            ...
                            if (cartTotal < coupon.minAmount) {
                              return { valid: false, message: `Minimum cart total of ₹${coupon.minAmount} required for this coupon.` };
                            }
                            if (coupon.category && !cartItems.some(item => item.category === coupon.category)) {
